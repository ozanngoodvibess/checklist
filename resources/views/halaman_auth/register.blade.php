...
@endif
					...
					<div class="wrap-input100 validate-input" data-validate = "No. Induk is required">
						<input class="input100" type="text" name="noin">
						<span class="focus-input100"></span>
						<span class="label-input100">No. Induk</span>
					</div>
